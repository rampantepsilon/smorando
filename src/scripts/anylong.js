  ...
  function generateSeed(){
      ...
      var metroList = "<b><u><a href='https://www.mariowiki.com/List_of_Power_Moons_in_the_Metro_Kingdom' target='_blank'>Metro Kingdom</a></u></b><div id='mkm1' onclick='highlight(this.id)'>" + myObj.metro[35] + "</div>";
      ...
      var luncheonList = "<br><b><u><a href='https://www.mariowiki.com/List_of_Power_Moons_in_the_Luncheon_Kingdom' target='_blank'>Luncheon Kingdom</a></u></b><div id='lukm1' onclick='highlight(this.id)'>" + myObj.luncheon[29] + "</div><div id='lukm2' onclick='highlight(this.id)'>" + myObj.luncheon[30] + "</div><div id='lukm3' onclick='highlight(this.id)'>" + myObj.luncheon[31] + "</div>";
      var ruinedList = "<br><b><u><a href='https://www.mariowiki.com/List_of_Power_Moons_in_the_Ruined_Kingdom' target='_blank'>Ruined Kingdom</a></u></b></br><div id='rkm1' onclick='highlight(this.id)'>" + myObj.ruined[0] + "</div>";
      var bowserList = "<br><b><u><a href='https://www.mariowiki.com/List_of_Power_Moons_in_Bowser&apos;s_Kingdom' target='_blank'>Bowser's Kingdom</a></u></b><div id='bkm1' onclick='highlight(this.id)'>" + myObj.bowser[21] + "</div><div id='bkm2' onclick='highlight(this.id)'>" + myObj.bowser[22] + "</div><div id='bkm3' onclick='highlight(this.id)'>" + myObj.bowser[23] + "</div><div id='bkm4' onclick='highlight(this.id)'>" + myObj.bowser[24] + "</div>";
